...
public class ReloadingAuthenticator {

    private static final Logger logger = LoggerFactory.getLogger(ReloadingAuthenticator.class);

    private ICredentialLookup credentialLookup;

    ReloadingAuthenticator(String credentialsJSON) {
